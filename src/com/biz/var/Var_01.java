...
public class Var_01 {
	...
	public static void main(String[] args) {
		...
		fNum1 = intNum1; // int형 변수에 담긴 값을 float형 변수에 담을수 있다
		intNum1 = (int)fNum1; // float형 변수에 담긴 값을 int형 변수에 담을수 없다
		/*
		 * 변수의 형변환
		 * 
		 * int형변수에 담긴 값을 float형에 담으려 하면 자동으로 
		 * 소수점이하에 값이 추가되어 float형으로 변환
		 * float형 변수에 담긴 값을 int형에 담으려 하면 
		 * 컴파일러는 개발자가 실수한 것이라고 생각한다.
		 * 그래서 문법 오류가 발생한다.
		 * 만약 개발자가 float형에 담긴 값을
		 * 소수점 이하를 무조건 잘라버리고 int형에 담겠다라고 선언할수있는데 
		 * 이런상황을 강제 형변환이라고 한다.
		 */
